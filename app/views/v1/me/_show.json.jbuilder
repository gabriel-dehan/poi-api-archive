json.extract! user, :id, :full_name, :email, :phone_number, :referrer_id, :referral_code 
...
json.funded_projects user.campaigns do |campaign|
  json.id campaign.id
...
json.connected_apps user.connected_applications do |connection|
...
json.perks do 
  json.partial! 'v1/perks/show', collection: Perk.all, as: :perk
end
...
json.projects do 
  ...
  json.projects do 
    json.partial! 'v1/campaigns/show', collection: Campaign.all, as: :campaign
  end
end
